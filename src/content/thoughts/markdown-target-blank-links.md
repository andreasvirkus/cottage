...
I also hope you're aware that without anything extra, a `_blank` link is exposed to [reverse tab-nabbing](https://securityintelligence.com/posts/what-is-reverse-tabnabbing-and-what-can-you-do-to-stop-it/). What that means is that the linked page can access your site's context (including localStorage, cookies, ...). No bueno. Luckily we can make sure to always append `rel="noreferrer noopener"` to those links.
